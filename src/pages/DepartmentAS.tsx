              ...
              <Card className="border-none shadow-lg">
                ...
                <CardContent className="prose max-w-none">
                  ...
                  <p className="text-gray-700 text-lg leading-relaxed">
                    In Applied Mathematics Branch, a number of courses have been offered to the students in semesters I, II & III. Mathematics I has course subjects like vector analysis, vectorial dynamics and mechanical vibrations. Mathematics II covers important topics like Analytical Geometry of 3-Dimensions, linear series, multiple integrals and differential equations.
                  </p>
                </CardContent>
              </Card>
