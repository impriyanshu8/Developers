        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl sm:text-2xl text-blue-100 mb-8 leading-relaxed">
              Pioneering Innovation in Mechanical Engineering
            </p>
              ...
              <Card className="border-none shadow-lg">
                ...
                <CardContent className="prose max-w-none">
                  <p className="text-gray-700 text-lg leading-relaxed mb-6">
                    A programme designed to ossify students’ concepts, the 8 semester course teaches students the basis of our mechanical studies as well as the latest operation management, research and analysis techniques practised in the industries.
                  </p>
                  <p className="text-gray-700 text-lg leading-relaxed mb-6">
                    The latest curriculum and mechanical design softwares to facilitate efficiency, research and to be in sync with the industry.
                  </p>
                  <p className="text-gray-700 text-lg leading-relaxed">
                    Faculty involved in the latest researches in the engineering world.
                  </p>
                  <br />
                  <p className="text-gray-700 text-lg leading-relaxed">
                    Top 4% students from all over India, today with sound technical base, equipped with operational knowledge in design softwares and an extensive industrial experience.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <ul className="text-gray-700 space-y-2">
                    <li>• To impart fundamental engineering skills & knowledge for analysis of engineering problems.</li>
                    <li>• To engage with Industry/Society for taking up stimulating problems on merits.</li>
                    <li>• To take the project execution to “Minimum Usable Prototype (MUP)” stage/Pilot-testing and secure IP rights.</li>
                  </ul>
                </CardContent>
              </Card>
            </div>
